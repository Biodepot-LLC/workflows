...
class OWdicom_uploader(OWBwBWidget):
    name = "dicom_uploader"
    description = "dicom upload google healthcare api"
    priority = 1
    icon = getIconName(__file__,"dicom-logo.jpg")
    want_main_area = False
    docker_image_name = "varikmp/dicomup"
    ...
    def __init__(self):
        ...
        with open(getJsonName(__file__,"dicom_uploader")) as f:
