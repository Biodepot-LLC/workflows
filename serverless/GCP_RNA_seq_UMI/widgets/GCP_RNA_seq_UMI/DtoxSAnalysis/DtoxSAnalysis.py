...
class OWDtoxSAnalysis(OWBwBWidget):
    ...
    docker_image_tag = "1.0__ubuntu_18.04__bioc-3.7__r_3.5.1__057cd1ee"
    inputs = [("RepositoryDirectory",str,"handleInputsRepositoryDirectory"),("ConfigurationFile",str,"handleInputsConfigurationFile"),("Trigger",str,"handleInputsTrigger"),("topGenesFile",str,"handleInputstopGenesFile")]
    ...
    def handleInputsTrigger(self, value, *args):
        if args and len(args) > 0: 
            ...
            self.handleInputs("inputFile", value, None, False)
    def handleInputstopGenesFile(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("topGenesFile", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
