...
from invokeGoogle import invokeFunctions
...
def main():
    ...
    parser.add_argument("-c",action='store',dest="credentials_file",default="/data/credentials.json",
                    help="credentials_file, file with Google credentials")
    ...
    parser.add_argument("--project",action='store',dest="project_id",default="serverless_123",
                    help="project_id, Project name that covers that serverless workflow")                          
    ...
    sys.stderr.write("credentials file={}\n".format(credentials_file))
    ...
    sys.stderr.write("project_id={}\n".format(project_id))      
    sys.stderr.write("bwa_string={}\n".format(bwa_string))  
    #get bwa string
    os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = credentials_file
    invokeFunctions(bucket_name,topic_name,work_dir,cloud_aligns_dir,recv_topic,fastq_suffix,upload_dir,project_id,max_workers,start_timeout,finish_timeout,bwa_string=bwa_string)
