...
class OWSplitUpload(OWBwBWidget):
    ...
    docker_image_name = "biodepot/umisplit_gcpupload"
    docker_image_tag = "277.0.0-alpine_3.11.3__2654d9b0"
    inputs = [("Trigger",str,"handleInputsTrigger"),("credentials_file",str,"handleInputscredentials_file"),("seqs_dir",str,"handleInputsseqs_dir"),("bucket",str,"handleInputsbucket"),("cloud_dir",str,"handleInputscloud_dir"),("outputdir",str,"handleInputsoutputdir"),("barcode",str,"handleInputsbarcode")]
