...
class OWStart(OWBwBWidget):
    ...
    outputs = [("credentials_file",str),("project_id",str),("bucket",str),("region",str),("cloud_dir",str),("parent_dir",str),("local_dir",str),("seqs_dir",str),("executables_dir",str),("cloud_executables_dir",str),("references_dir",str),("cloud_references_dir",str),("aligns_dir",str),("cloud_aligns_dir",str),("DEG_configuration_file",str),("topGenesFile",str),("barcodeFile",str),("safDir",str),("local_safDir",str),("function_dir",str),("function_name",str)]
    ...
    def handleOutputs(self):
        ...
        if hasattr(self,"project_id"):
            outputValue=getattr(self,"project_id")
        self.send("project_id", outputValue)
        outputValue=None
        ...
        outputValue=None
        if hasattr(self,"local_safDir"):
            outputValue=getattr(self,"local_safDir")
        self.send("local_safDir", outputValue)
        outputValue=None
        if hasattr(self,"function_dir"):
            outputValue=getattr(self,"function_dir")
        self.send("function_dir", outputValue)
        outputValue=None
