...
class OWgzip(OWBwBWidget):
    ...
    inputs = [("FastQCompressedFile",str,"handleInputsFastQCompressedFile"),("Trigger",str,"handleInputsTrigger")]
    ...
    def handleInputsFastQCompressedFile(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("FastQCompressedFile", value, args[0][0], test=args[0][3])
        else:
