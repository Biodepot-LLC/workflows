...
class OWAWS_RNA_seq_UMI_lite_S3_download(OWBwBWidget):
    name = "AWS_RNA_seq_UMI_lite_S3_download"
    ...
    def __init__(self):
        ...
        with open(getJsonName(__file__,"AWS_RNA_seq_UMI_lite_S3_download")) as f:
